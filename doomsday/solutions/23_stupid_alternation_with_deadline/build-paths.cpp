...
int main() {
	...
	int64_t duration = duration_cast<microseconds>(stop - start).count();
	// I lost a lot of attempts because I don't know what a microsecond is...
	if (duration > 279000) while (true);
}
